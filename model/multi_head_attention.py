...
class MultiHeadedSelfAttention(nn.Module):
    ...
    def __init__(self, embedding_dim: int, attention_dim: int, num_heads: int):
        ...
        self.attention_heads = [self.SingleHeadAttention(embedding_dim, head_size) for _ in range(num_heads)]
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        results = [y(embedded) for y in self.attention_heads]
        concatenated = torch.concat(results, dim=-1)
